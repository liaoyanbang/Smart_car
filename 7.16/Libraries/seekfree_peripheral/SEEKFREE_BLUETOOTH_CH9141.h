...
#define BLUETOOTH_CH9141_TIMER_N    	  TIM_4
#define BLUETOOTH_CH9141_UART_BAUD      115200

#define BLUETOOTH_CH9141_DATA_BUF       S4BUF

#define BLUETOOTH_CH9141_RTS_PIN        P75             //定义流控位引脚  指示当前模块是否可以接受数据  0可以继续接收  1不可以继续接收
...
extern uint8 uart_data[uart_data_MAXLEN];
