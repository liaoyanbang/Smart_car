...
#define delta_T     0.005f  //100ms计算一次
#define M_PI        3.1415926f
#define PI        3.1415926f
//--------------------软件SPI--------------------
#define ICM20602_SCK_PIN   		P71
#define ICM20602_MOSI_PIN  		P72
#define ICM20602_MISO_PIN  		P41
#define ICM20602_CSN_PIN 		  P70
...
extern void ICM_AHRSupdate(float gx, float gy, float gz, float ax, float ay, float az);

extern void ICM_getValues();
